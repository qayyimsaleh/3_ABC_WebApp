...
Usage:
    ...
    python abc_security_tester.py --url https://YOUR-SERVER/ABC_WebApp --emp EMP001 --ic YOUR_IC

    # If your IIS uses Windows Authentication:
    python abc_security_tester.py --url https://YOUR-SERVER/ABC_WebApp --emp EMP001 --ic YOUR_IC --windows-auth
"""
